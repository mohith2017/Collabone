...
function FileSystem() {
    ...
    const [editingFileId, setEditingFileId] = useState<FileId | "">("")
    ...
    return (
        <>
            ...
            <button
                className="my-2 flex w-full justify-center rounded-md bg-gray-400 p-2 font-bold text-black transition-all"
